        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="nav-item_group">
                    ...
                    <div class="nav-category">
                        <span class="nav-title">Classement</span>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/Classement/familles_medicaments/lister') }}">Familles de médicaments</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/Classement/prescription_medicaments') }}">Prescriptions de médicaments</a>
                            </li>
                        </ul>
                    </div>
