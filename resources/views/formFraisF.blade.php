    ...
    <form method="POST" action="{{ url('/Frais/modifier/forfait/valider') }}">
        ...
        <div class="col-md-12 card card-body bg-light">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" value="{{$unFraisF->lib_fraisforfait}}" maxlength="100">
                </div>
            </div>
			<div class="form-group">
                <label class="col-md-3">Montant</label>
                <div class="col-md-6">
                    <div class="money-group"> <input type="number" class="form-control" value="{{$unFraisF->montant_frais_forfait}}" step="0.01" min="0"> € </div>
                </div>
            </div>
            <hr>
            <div class="form-group">
                <div class="col-md-12 col-md-offset-3">
                    ...
                    @if ($unFraisF->id_fraisforfait)
                        <a href="{{ url("/Frais_forfait/supprimer/".$id_fraisF) }}" id="suppr" class="btn btn-danger" onclick="if (confirm ('Supprimer ce frais au forfait de ce frais ?'));">
                            Supprimer
                        </a>
                    @endif
                </div>
